...
<jsp:include page="../common/header.jsp" />
  ...
  <div class="panel panel-default">
    <div class="panel-heading">회원정보 수정양식</div>
    	...
    	<input type="hidden" id="memPassword" name="memPassword"/>
    		<table class="table table-bordered" style="text-align:center; border:1px solid #dddddd;">
    			...
    			<tr>
    				...
    				<td colspan="2"><input class="form-control" id="memEmail" name="memEmail" type="email" maxlength="20" placeholder="이메일을 입력하세요" value="${mvo.memEmail }"/></td>
    			</tr> 
    			<tr>
    				<td colspan="3" style="text-align:left;">
    					<span id="passMessage" style="color:red;"></span><input type="button" class="btn btn-primary btn-sm pull-right" onclick="goUpdate()" value="수정"/>
    				</td>		
    			</tr> 
    		</table>
    	</form>
